                ...
                <div class="wrap-product-detail">
                        ...
                        <div class="product-gallery" wire:ignore>
                            <ul class="slides">
                                <li data-thumb="{{ asset('assets/images/products' ) }}/{{$product->image}}">
                                    <img src="{{ asset('assets/images/products') }}/{{$product->image}}" class="img_shop" alt="{{$product->name}}" />
                                </li> 
                                @php 
                                ...
                                @foreach($images as $image)
                                    @if($image)
                                        <li data-thumb="{{ asset('assets/images/products' ) }}/{{$image}}">
                                            <img src="{{ asset('assets/images/products') }}/{{$image}}" alt="{{$product->name}}" class="g_img_shop"/>
                                        </li> 
                                    @endif
                                @endforeach                          
                            </ul>
                    ...
                    <div class="detail-info">
                        ...
                        {{-- <div class="wrap-social">
                            <a class="link-socail" href="#"><img src="{{ asset('assets/images/social-list.png') }}" class="img_shop" alt=""></a>
                        </div> --}}
